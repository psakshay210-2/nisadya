                ...
                <div className="mt-8 text-center">
                    <div className="flex items-center justify-center gap-6">
                        <button
                            ...
                            className="p-4 rounded-full bg-secondary/10 hover:bg-secondary/20 border border-border hover:border-primary/50 text-foreground transition-transform duration-300 hover:scale-110 active:scale-90 group"
                        ...
                        <button
                            ...
                            className="p-4 rounded-full bg-secondary/10 hover:bg-secondary/20 border border-border hover:border-secondary/50 text-foreground transition-transform duration-300 hover:scale-110 active:scale-90 group"
