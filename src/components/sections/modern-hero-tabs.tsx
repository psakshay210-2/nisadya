...
export function ModernHeroTabs() {
    ...
    return (
        <div className="flex flex-col w-full h-auto md:h-full max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex justify-center p-2 bg-black/20 backdrop-blur-xl border border-white/10 rounded-full mx-auto w-full max-w-2xl shadow-2xl">
                {tabs.map((tab) => {
                    const Icon = tab.icon;
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "relative w-full flex items-center justify-center gap-2 py-3 rounded-full transition-all duration-500 ease-out overflow-hidden group",
